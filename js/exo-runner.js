/* ============================================================
   exo-runner.js — Atelier de code des exercices « front »
   ------------------------------------------------------------
   ...
   (les exercices à tests automatiques ne s'appuient donc pas
    ...
    function renderResults(results, errors) {
      ...
      if (results.length && passed === results.length && !errors.length) {
        resultsBox.insertAdjacentHTML('afterbegin',
          ...
          '<span><strong>Tous les tests passent — exercice réussi !</strong>' +
    ...
    runBtn.addEventListener('click', function () {
      ...
      timeoutId = setTimeout(function () {
        ...
        resultsBox.innerHTML =
          ...
          '<strong>Aucune réponse du rendu.</strong><span class="t-help">Cet exercice charge peut-être une ' +
