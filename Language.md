...
**Totaux : 364 fiches · 85 exercices · 17 accents de couleur dédiés.**
...
| **React JS** | Bibliothèque d'interfaces | 20 | 5 | Tests auto dans le navigateur | `#0797b8` | `js/data-react.js` |
| **Tailwind CSS** | Framework CSS utilitaire | 15 | 5 | Tests auto dans le navigateur | `#0891b2` | `js/data-tailwind.js` |
| **Vue.js** | Framework progressif | 28 | 5 | Tests auto dans le navigateur | `#2f9e6c` | `js/data-vue.js` |
...
| **Laravel** | Framework PHP | 17 | 5 | Auto-évaluation en local | `#ee3820` | `js/data-laravel.js` |
| **TanStack Query** | Gestion des données serveur | 13 | 5 | Auto-évaluation en local | `#e8364f` | `js/data-tanstack.js` |
| **Python** | Langage polyvalent | 18 | 5 | Auto-évaluation en local | `#306998` | `js/data-python.js` |
| **Flask** | Micro-framework Python | 16 | 5 | Auto-évaluation en local | `#3a3a3c` | `js/data-flask.js` |
| **Django** | Framework Python complet | 19 | 5 | Auto-évaluation en local | `#0c4b33` | `js/data-django.js` |
...
| Langage | Rôle | Fiches | Exercices | Correction | Accent | Contenu |
|---|---|---|---|---|---|---|
| **React Native** | Applications mobiles | 23 | 5 | Auto-évaluation en local | `#00a9ce` | `js/data-reactnative.js` |
